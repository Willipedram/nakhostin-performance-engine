...
platform for WordPress and WooCommerce. Version 1.2.1 makes the source repository fully text-only and moves compiled translation binaries into the release packaging step. CSS tree shaking remains intentionally unavailable.
