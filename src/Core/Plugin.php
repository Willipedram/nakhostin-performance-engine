...
final class Plugin {
	...
	public function boot(): void {
		...
		if ( is_admin() ) {
			...
			$this->services->get( CSSAdminPage::class )->register();
	...
	private function register_services(): void {
		...
		$this->services->set(
			CSSAdminPage::class,
			static function ( ServiceRegistry $services ): CSSAdminPage {
				return new CSSAdminPage(
					$services->get( CSSAnalyzer::class ),
					$services->get( CSSStorage::class ),
		...
		$this->services->set( ObservedScriptResolver::class, new ObservedScriptResolver() );
		...
		$this->services->set(
			PageAnalysisCoordinator::class,
			static function ( ServiceRegistry $services ): PageAnalysisCoordinator {
				return new PageAnalysisCoordinator(
					$services->get( DOMAnalyzer::class ),
					$services->get( DOMStorageInterface::class ),
					$services->get( ComponentRegistry::class ),
					$services->get( CSSAnalyzer::class ),
					$services->get( CSSStorage::class ),
					$services->get( StylesheetSourceCollector::class ),
					$services->get( ScriptDiscovery::class ),
					$services->get( LocalScriptSourceProvider::class ),
					$services->get( ObservedScriptResolver::class ),
