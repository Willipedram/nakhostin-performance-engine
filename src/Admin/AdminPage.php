...
final class AdminPage {
	...
	private function render_settings(): void {
		...
		<div class="npe-card">
			...
			<p><label><?php echo esc_html__( 'Sample rate (percent)', 'nakhostin-performance-engine' ); ?><br><input type="number" min="1" max="100" name="npe_settings[performance][sample_rate]" value="<?php echo esc_attr( $settings['performance']['sample_rate'] ); ?>"></label></p>
			<p><label><?php echo esc_html__( 'Retention (days)', 'nakhostin-performance-engine' ); ?><br><input type="number" min="1" max="90" name="npe_settings[performance][retention_days]" value="<?php echo esc_attr( $settings['performance']['retention_days'] ); ?>"></label></p>
			<p><label><?php echo esc_html__( 'Maximum samples', 'nakhostin-performance-engine' ); ?><br><input type="number" min="10" max="2000" name="npe_settings[performance][max_samples]" value="<?php echo esc_attr( $settings['performance']['max_samples'] ); ?>"></label></p>
		</div>
		<div class="npe-card">
