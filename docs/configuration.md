...
| CSS | Explicit DOM-manifest selector usage analysis | Available on demand; no automatic removal |
...
`FeatureFlags::AVAILABLE_MODULES`: DOM Intelligence, CSS analysis, JavaScript,
Cache, LiteSpeed, and Performance are available. WooCommerce, Elementor, and
