...
- `DOM` owns structural page analysis. Future `CSS` analysis and current
...
Asset optimization will construct dependency graphs from registered WordPress
assets and observed markup. CSS selector use and JavaScript dependencies will be
analyzed conservatively. Generated page-specific artifacts will retain ordering,
...
5. **CSS analysis:** conservative usage models and auditable artifact generation
   with rollback.
