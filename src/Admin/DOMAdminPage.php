...
final class DOMAdminPage {
	...
	public function render(): void {
		...
		<div class="wrap npe-admin" dir="<?php echo esc_attr( is_rtl() ? 'rtl' : 'ltr' ); ?>">
			...
			<p>
				<?php
				echo esc_html__(
					'Analysis runs only when explicitly requested and stores no page HTML.',
			...
			<div class="npe-card">
				<h2><?php echo esc_html__( 'Run Analysis', 'nakhostin-performance-engine' ); ?></h2>
				<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
					...
					<?php submit_button( __( 'Run Analysis', 'nakhostin-performance-engine' ) ); ?>
				</form>
			</div>
	...
	private function render_notice(): void {
		...
		$notices = array(
			'success'         => __( 'DOM analysis completed.', 'nakhostin-performance-engine' ),
