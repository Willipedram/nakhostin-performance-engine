...
platform for WordPress and WooCommerce. Version 1.3.0 adds review-only CSS usage analysis, page-specific JavaScript requirement reporting, and clearer Persian guidance. Automatic CSS tree shaking remains intentionally unavailable.
