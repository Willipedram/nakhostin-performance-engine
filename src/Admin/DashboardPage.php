...
final class DashboardPage {
	...
	private function links(): array { return array( CacheAdminPage::SLUG => __( 'Cache', 'nakhostin-performance-engine' ), DOMAdminPage::SLUG => __( 'DOM Intelligence', 'nakhostin-performance-engine' ), JavaScriptAdminPage::SLUG => __( 'JavaScript', 'nakhostin-performance-engine' ), ComponentsAdminPage::SLUG => __( 'Components', 'nakhostin-performance-engine' ), PerformanceAdminPage::SLUG => __( 'Performance', 'nakhostin-performance-engine' ), DiagnosticsAdminPage::SLUG => __( 'Diagnostics', 'nakhostin-performance-engine' ), AdminPage::SETTINGS_SLUG => __( 'Settings', 'nakhostin-performance-engine' ) ); }
}
